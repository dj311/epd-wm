...
static void xdg_popup_create(
  struct cg_view *view,
  struct wlr_xdg_popup *wlr_popup
);

static void
popup_handle_new_xdg_popup(
  struct wl_listener *listener,
  void *data
)
{
...
)
{
  ...
  struct wlr_box *output_box =
    wlr_output_layout_get_box(output_layout, output);
...
static void
handle_xdg_shell_surface_commit(
  struct wl_listener *listener,
  void *data
)
{
...
static void
handle_xdg_shell_surface_unmap(
  struct wl_listener *listener,
  void *data
)
{
...
static void
handle_xdg_shell_surface_destroy(
  struct wl_listener *listener,
  void *data
)
{
