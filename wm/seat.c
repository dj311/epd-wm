...
)
{
  ...
  int nsyms =
    xkb_state_key_get_syms(keyboard->device->keyboard->xkb_state, keycode,
                           &syms);
...
)
{
  ...
  bool has_focused = focused_surface != NULL
    && focused_surface->resource != NULL;
